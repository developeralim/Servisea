    ...
    <div class="row">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" placeholder="10" id="JR_REMUNERATION" name="JR_REMUNERATION">
            </div>
            <div class="mb-3">
                <label for="project" class="form-label">Let's talk timing</label>
                <input type="date" class="form-control" id="JR_DELIVERYDATE"  name="JR_DELIVERYDATE4" rows="3"></input>
            </div>
        </div>
    </div>
 </div>
